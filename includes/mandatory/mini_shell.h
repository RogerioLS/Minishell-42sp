...
// Prompt
void						initialize_lists(t_token **token_list,
								t_tree **tree_list);
int							prompt(void);
...
void						initialize_node(t_token *new_node, t_tree **lists,
								int mode);
t_tree						*break_nodes(t_token *current, t_tree **lists,
								int mode);
void						for_left_node(tokens opr, t_tree *nodes_in_exec,
								t_tree **lists);
void						for_right_node(tokens opr, t_tree *nodes_in_exec,
								t_tree **lists);
int							planting_tree(t_token **token_list, tokens opr,
								t_tree **lists);
...
int							initialize_buildtoken(char *cmd_line,
								t_token **token_list);
...
void						ongoing_tree(t_tree *node, t_tree **tree_list,
								t_token **token_list);
void						for_each_cmd(t_tree *node, t_token **token_list);
void						initialize_execution(t_tree **tree_list,
								t_token **token_list);
